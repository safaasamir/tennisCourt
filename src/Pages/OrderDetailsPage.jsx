              ...
              <React.Fragment key={index}>
                ...
                <div className="md:hidden ms-5">
                  <div className="flex gap-x-2">
                    ...
                    <p className="md:col-span-1 text-lg">{slot.courtName}</p>
                  </div>
                ...
                <p className="md:col-span-1 hidden md:block">{slot.date}</p>
                <p className="md:col-span-1 hidden md:block">{slot.time}</p>
                <p className="md:col-span-1 hidden md:block">{slot.price}</p>
